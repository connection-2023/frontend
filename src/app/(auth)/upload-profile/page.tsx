...
import { AddImageSVG } from '@/../public/icons/svg';
...
const UploadProfile = () => {
  ...
  return (
    <section className="mx-auto mt-2 flex h-max w-full max-w-[25.5rem] flex-grow flex-grow flex-col items-center rounded-md bg-white px-4 py-10 shadow-float">
      ...
      <label htmlFor="upload-button" className="group">
        ...
        >
          {/* trashcan Icon 추가하기 */}
          <div className="flex h-full w-full items-center justify-center group-hover:backdrop-brightness-50">
            <AddImageSVG
              width="59"
              height="59"
              role="img"
